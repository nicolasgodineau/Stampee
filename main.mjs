...
if (document.title.toLocaleLowerCase() == "catalogue") {
    // Permet d'appeler la fonction si le titre de la page est catalogue
    remplissageCatalogue(); // appel de la fonction
} else if (document.title.toLocaleLowerCase() == "accueil") {
    // Permet d'appeler la fonction si le titre de la page est accueil
    remplissageCartesIndex(); // appel de la fonction
}
function remplissageCatalogue() {
...
function remplissageCartesIndex() {
    cartes.forEach((element, index) => {
        // création d'un dataset pour identifier les timbres
        let datasetTimbre = element.dataset.timbre;
        datasetTimbre = CatalogueTimbres[index].timbre;
